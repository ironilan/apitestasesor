...
@section('contenido')
<div class="container">
    <h1 class="mt-4 mb-4 text-center">Módulos de Clientes</h1>
    <div id="app_tabla">
        <button class="btn btn-success" onclick="crear()">Crear cliente</button>
        <div class="row">
        ...
        <div class="row">
            <div class="col-6">
                <form id="formActualizar">
                    ...
                    <div class="form-group mb-2">
                        <input type="text" class="form-control" name="codigo" placeholder="Código" id="codigo">
                    </div>
                    <div class="boton mb-2">
